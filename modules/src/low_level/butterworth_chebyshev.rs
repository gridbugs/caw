// This is based on the butterworth and chebyshev filter designs at:
...
#[derive(Debug)]
struct BandPassBuffer {
    entries: Vec<BandPassBufferEntry>,
}

impl BandPassBuffer {
    fn new(filter_order_quarter: usize) -> Self {
        let mut entries = Vec::new();
...
pub mod butterworth {
    ...
    impl BandPassState {
        pub fn new(filter_order_quarter: usize) -> Self {
            Self {
                buffer: BandPassBuffer::new(filter_order_quarter),
