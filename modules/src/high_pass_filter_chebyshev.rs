...
builder! {
    #[constructor = "high_pass_filter_chebyshev"]
    #[constructor_doc = "A high pass filter with adjustable resonance"]
    #[build_fn = "Props::new"]
    #[build_ty = "Props<C, R>"]
    ...
    R: SigT<Item = f32>,
{
    ...
    type Out<S> = HighPassFilterChebyshev<S, C, R>
    where
...
pub struct HighPassFilterChebyshev<S, C, R>
where
    S: SigT<Item = f32>,
    C: SigT<Item = f32>,
    R: SigT<Item = f32>,
...
impl<S, C, R> SigT for HighPassFilterChebyshev<S, C, R>
where
    S: SigT<Item = f32>,
    C: SigT<Item = f32>,
    R: SigT<Item = f32>,
